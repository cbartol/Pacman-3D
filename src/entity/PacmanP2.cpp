...
void PacmanP2::draw(bool gameOver, bool gameWin){
	if(!_isDead){
		glPushMatrix();
...
inline void PacmanP2::pacEyebrows(){
	GLfloat eyebrown_Ka[] = { 0. , 0. , 0., 1.};
	GLfloat eyebrown_Kd[] = { 1.0 , 1.0 , 0.0, 1.};
...
void PacmanP2::pacBody(){
	GLfloat body_Ka[] = { 0. , 0. , 0., 1.};
	GLfloat body_Kd[] = { .0 , .0 , .0, 1.};
	GLfloat body_Ks[] = { 0.63 , 0.56 , 0.37, 1.};
	GLfloat body_Ke[] = { 0.0 , 0.0 , 0.0, 1.};
